...
[![Typing SVG](https://readme-typing-svg.herokuapp.com/?color=e6ca30&size=35&center=true&vCenter=true&width=1000&lines=We+like+malware+develop;We+like+to+use+Csharp+Python+Assembly+and+Cpp!;We+like+program+stuff;We+like+OS+develop)](https://git.io/typing-svg)
...
[![my skills](https://skillicons.dev/icons?i=windows,cs,cpp,html,c,python,bash,powershell,net,ts,js,java)](https://skillicons.dev)
